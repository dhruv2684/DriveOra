      ...
      <Container fluid className="mt-5 mb-5">
        <Row className='align-items-center'>
          <div className="col-md-5 col-12 p-5 order-2">
            <h2 className="fs-1 mb-4">FORD ENIM NIBH<br></br> LITORA</h2>
            ...
            <p className='mt-4'><span>$</span>3,500.00</p>
            <Button variant="" className='b-color text-white rounded-0 border-0 ps-5 pe-5 pt-3 pb-3'>CONFIGURE</Button>{' '}
          </div>
          <div className="col-md-7 col-12">
            <Link to=""> <img src="https://themes.muffingroup.com/be/leasing2/wp-content/uploads/2023/02/beleasing2-product-pic2-800x573.webp" width="100%" alt="" /></Link>
          </div>
        </Row>
      </Container>
        ...
        <Row className='g-1'>
          <div className="col-lg-4 col-12 ">
            <div className="bg-white p-5">
              ...
              <h4 className="pb-4 border-bottom fs-3 mb-3">FORD ENIM NIBH LITORA<br></br> A</h4>
          ...
          <div className="col-lg-4 col-12 ">
            <div className="bg-white p-5">
              ...
              <h4 className="pb-4 border-bottom fs-3 mb-3">FORD ENIM NIBH LITORA<br></br> B</h4>
          ...
          <div className="col-lg-4 col-12 ">
            <div className="bg-white p-5">
              ...
              <h4 className="pb-4 border-bottom fs-3 mb-3">FORD ENIM NIBH LITORA<br></br> C</h4>
