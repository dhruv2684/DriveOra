      ...
      <Container fluid className="mt-5 mb-5">
        <Row className='align-items-center'>
          <div className="col-md-5 col-12 p-5 order-2">
            <h2 className="fs-1 mb-4">MERCEDES MATTIS<br></br> ARCU MAXIMUS </h2>
          ...
          <div className="col-md-7 col-12">
            <Link to=""> <img src="https://themes.muffingroup.com/be/leasing2/wp-content/uploads/2023/02/beleasing2-product-pic6-800x573.webp" width="100%" alt="" /></Link>
          </div>
        </Row>
      </Container>
        ...
        <Row className='g-1'>
          <div className="col-lg-4 col-12 ">
            <div className="bg-white p-5">
              ...
              <h4 className="pb-4 border-bottom fs-3 mb-3">MERCEDES MATTIS ARCU MAXIMUS A</h4>
          ...
          <div className="col-lg-4 col-12 ">
            <div className="bg-white p-5">
              ...
              <h4 className="pb-4 border-bottom fs-3 mb-3">MERCEDES MATTIS ARCU MAXIMUS B</h4>
          ...
          <div className="col-lg-4 col-12 ">
            <div className="bg-white p-5">
              ...
              <h4 className="pb-4 border-bottom fs-3 mb-3">MERCEDES MATTIS ARCU MAXIMUS C</h4>
